...
public class GuestServicesApplication {
    ...
    public Docket api() {
        return new Docket(SWAGGER_2)
                .groupName("Guest")
                .select()
                .apis(basePackage(GuestServicesApplication.class.getPackage().getName()))
                .paths(any())
                .build()
                .apiInfo(new ApiInfo("Guest Services", "A set of services to provide data access to guests", "1.0.0",
